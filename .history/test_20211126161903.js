...
function handlUpdateCourses (id) {
    globalId = id;
    document.querySelector('input[name=name]').value = document.querySelector('.name-'+id).innerText;
    document.querySelector('input[name=age]').value = document.querySelector('.age-' + id).innerText;
    document.querySelector('.createInfo').style.display = 'none'
    document.querySelector('.updateInfo').style.display = 'block'
    
}

function aa (id,data,callback) {
    var objectCourse = {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json'},
...
function updateCourse() {
    ...
    saveBtn.onclick = function() {
        ...
        var newFormData = {
          ...
          aa(globalId,newFormData,function(){
        getCourses(renderCourses)
        })
