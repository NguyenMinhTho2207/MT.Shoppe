...
function handlUpdateCourses (id) {
    document.querySelector('input[name=name]').value = document.querySelector('.item-' + id).textContent
    document.querySelector('input[name=age]').value = document.querySelector('.item-' + id).textContent
