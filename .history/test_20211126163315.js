...
function updateCourse() {
    ...
    var newAge = document.querySelector('input[name="agr"]').value
    var newFormData = {
      name: newName,
      description: newAge
    }
        ...
        document.querySelector('.createInfo').style.display ='block'
        document.querySelector('.updateInfo').style.display ='none'
